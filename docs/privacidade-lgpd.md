...
Prefeitura GO Rio Verde: Certidão Negativa de Débitos segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_go_rio_verde_cnd@mcp.ai](mailto:pref_go_rio_verde_cnd@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
